...
<a href="/blog/posts/latex-vs-word-docs/" data-proofer-ignore>이전 글 #11</a> 에서 LaTeX 가 Word·Google Docs 와 어떻게 다른지 이야기했다면, 이번 글은 그 다른 도구의 **입장권** 입니다. 10분 안에 첫 페이지가 만들어집니다.
...
Overleaf 만으로 논문을 처음부터 끝까지 쓰는 것도 좋지만, **초안은 Docs/Word, 완성은 LaTeX** 의 두 도구 분담이 <a href="/blog/posts/latex-vs-word-docs/" data-proofer-ignore>#11</a> 에서 이야기한 현실적인 워크플로우입니다. 본문을 익숙한 도구에서 빠르게 쏟아 두고, 수식과 최종 PDF 만 LaTeX 로 넘기는 방식입니다.
...
이전 글: <a href="/blog/posts/latex-vs-word-docs/" data-proofer-ignore>#11 Word·Google Docs 로 논문 쓰다 막힌 분께 — LaTeX 가 다른 이유</a>
