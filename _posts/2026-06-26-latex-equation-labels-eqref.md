...
다음 글에서는 이 수식 작업들 사이에서 가장 자주 발생하는 **5가지 실수 패턴과 해결법** — 첨자 중괄호 빼먹기부터 함수 이름 이탤릭체까지 — 을 한 번에 정리합니다.

---

이전 글: [#5 LaTeX `align` 환경으로 수식 정렬하기]({% post_url 2026-06-24-latex-align-equations %})
다음 글: [#7 LaTeX 수식에서 흔히 하는 5가지 실수와 해결법]({% post_url 2026-06-29-latex-equation-5-mistakes %})
